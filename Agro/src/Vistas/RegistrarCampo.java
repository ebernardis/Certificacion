...
public class RegistrarCampo extends javax.swing.JFrame {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(121, 121, 121)
                                        .addComponent(labelInformacion, javax.swing.GroupLayout.PREFERRED_SIZE, 351, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(textNombre, javax.swing.GroupLayout.PREFERRED_SIZE, 361, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(0, 0, Short.MAX_VALUE))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(237, 237, 237)
    ...
    private void textNombreFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_textNombreFocusLost
        ...
        if (controladorCampo.buscarCampoPorNombre(nombre)) {
            this.labelInformacion.setText("ERROR: Nombre de campo ya existe!");
            this.botonRegistrarCampo.setEnabled(false);
        }
        ...
        if (!this.textNumeroLote.getText().trim().isEmpty()) {
            ...
            while (it.hasNext()) {
                if (((Lote) it.next()).getNumeroLote() == numeroLoteBuscado) {
                    JOptionPane.showMessageDialog(null, "Por favor ingrese un nuevo número de Lote", "Ya existe un Lote con ese número", JOptionPane.ERROR_MESSAGE);
